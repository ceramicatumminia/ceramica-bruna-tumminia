  ...
  return (
    <section style={{
      ...
      <div style={{padding: mobile ? '48px 24px' : '60px 60px 40px', display:'flex', flexDirection:'column', justifyContent:'center', alignItems: mobile ? 'center' : 'flex-start', textAlign: mobile ? 'center' : 'left'}}>
        ...
        <p style={{fontFamily:'Parisienne,cursive',fontSize:'20px',lineHeight:'2',color:'var(--text-muted)',maxWidth: mobile ? '100%' : '400px',marginBottom:'36px'}}>Ceramiche artistiche interamente realizzate e decorate a mano. Ogni pezzo nasce da un dialogo silenzioso tra le mani e l&apos;argilla.</p>
